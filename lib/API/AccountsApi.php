...
class AccountsApi
{
     ...
     * @param  string[] $fields_account For more information please visit https://developers.klaviyo.com/en/v2023-12-15/reference/api-overview#sparse-fieldsets (optional)
     *
